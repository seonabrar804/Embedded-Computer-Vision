...
class Model(nn.Module):
    def __init__(self):
        ...
        self.model_23_cv4_2_1_act = nn.SiLU()
        ...
        self.model_23_cv4_0_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(3,3), out_channels=32, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_78 = nn.SiLU()
        self.model_23_cv4_0_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=32, kernel_size=(3,3), out_channels=32, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_79 = nn.SiLU()
        self.model_23_cv4_0_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=32, kernel_size=(1,1), out_channels=32, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.model_23_cv4_1_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=128, kernel_size=(3,3), out_channels=32, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_80 = nn.SiLU()
        self.model_23_cv4_1_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=32, kernel_size=(3,3), out_channels=32, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_81 = nn.SiLU()
        self.model_23_cv4_1_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=32, kernel_size=(1,1), out_channels=32, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.model_23_cv4_2_0_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=256, kernel_size=(3,3), out_channels=32, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_82 = nn.SiLU()
        self.model_23_cv4_2_1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=32, kernel_size=(3,3), out_channels=32, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_83 = nn.SiLU()
        self.model_23_cv4_2_2 = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=32, kernel_size=(1,1), out_channels=32, padding=(0,0), padding_mode='zeros', stride=(1,1))
        ...
        self.model_23_proto_cv1_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(3,3), out_channels=64, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_84 = nn.SiLU()
        self.model_23_proto_upsample = nn.ConvTranspose2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(2,2), out_channels=64, output_padding=(0,0), padding=(0,0), stride=(2,2))
        self.model_23_proto_cv2_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(3,3), out_channels=64, padding=(1,1), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_85 = nn.SiLU()
        self.model_23_proto_cv3_conv = nn.Conv2d(bias=True, dilation=(1,1), groups=1, in_channels=64, kernel_size=(1,1), out_channels=32, padding=(0,0), padding_mode='zeros', stride=(1,1))
        self.pnnx_unique_86 = nn.SiLU()

        archive = zipfile.ZipFile('yolo11n_seg.pnnx.bin', 'r')
        ...
        self.model_23_cv4_0_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.0.0.conv.bias', (32), 'float32')
        self.model_23_cv4_0_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.0.0.conv.weight', (32,64,3,3), 'float32')
        self.model_23_cv4_0_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.0.1.conv.bias', (32), 'float32')
        self.model_23_cv4_0_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.0.1.conv.weight', (32,32,3,3), 'float32')
        self.model_23_cv4_0_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.0.2.bias', (32), 'float32')
        self.model_23_cv4_0_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.0.2.weight', (32,32,1,1), 'float32')
        self.model_23_cv4_1_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.1.0.conv.bias', (32), 'float32')
        self.model_23_cv4_1_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.1.0.conv.weight', (32,128,3,3), 'float32')
        self.model_23_cv4_1_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.1.1.conv.bias', (32), 'float32')
        self.model_23_cv4_1_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.1.1.conv.weight', (32,32,3,3), 'float32')
        self.model_23_cv4_1_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.1.2.bias', (32), 'float32')
        self.model_23_cv4_1_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.1.2.weight', (32,32,1,1), 'float32')
        self.model_23_cv4_2_0_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.2.0.conv.bias', (32), 'float32')
        self.model_23_cv4_2_0_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.2.0.conv.weight', (32,256,3,3), 'float32')
        self.model_23_cv4_2_1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.2.1.conv.bias', (32), 'float32')
        self.model_23_cv4_2_1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.2.1.conv.weight', (32,32,3,3), 'float32')
        self.model_23_cv4_2_2.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.2.2.bias', (32), 'float32')
        self.model_23_cv4_2_2.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.cv4.2.2.weight', (32,32,1,1), 'float32')
        self.model_23_dfl_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.dfl.conv.weight', (1,16,1,1), 'float32')
        self.model_23_proto_cv1_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.cv1.conv.bias', (64), 'float32')
        self.model_23_proto_cv1_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.cv1.conv.weight', (64,64,3,3), 'float32')
        self.model_23_proto_upsample.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.upsample.bias', (64), 'float32')
        self.model_23_proto_upsample.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.upsample.weight', (64,64,2,2), 'float32')
        self.model_23_proto_cv2_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.cv2.conv.bias', (64), 'float32')
        self.model_23_proto_cv2_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.cv2.conv.weight', (64,64,3,3), 'float32')
        self.model_23_proto_cv3_conv.bias = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.cv3.conv.bias', (32), 'float32')
        self.model_23_proto_cv3_conv.weight = self.load_pnnx_bin_as_parameter(archive, 'model.23.proto.cv3.conv.weight', (32,64,1,1), 'float32')
    ...
    def forward(self, v_0):
        ...
        v_2 = self.model_23_cv4_2_1_act(v_1)
        ...
        v_238 = v_237.reshape(1, 80, 400)
        v_239 = torch.cat((v_218, v_228, v_238), dim=-1)
        v_240 = self.model_23_cv4_0_0_conv(v_146)
        v_241 = self.pnnx_unique_78(v_240)
        v_242 = self.model_23_cv4_0_1_conv(v_241)
        v_243 = self.pnnx_unique_79(v_242)
        v_244 = self.model_23_cv4_0_2(v_243)
        v_245 = v_244.reshape(1, 32, 6400)
        v_246 = self.model_23_cv4_1_0_conv(v_161)
        v_247 = self.pnnx_unique_80(v_246)
        v_248 = self.model_23_cv4_1_1_conv(v_247)
        v_249 = self.pnnx_unique_81(v_248)
        v_250 = self.model_23_cv4_1_2(v_249)
        v_251 = v_250.reshape(1, 32, 1600)
        v_252 = self.model_23_cv4_2_0_conv(v_188)
        v_253 = self.pnnx_unique_82(v_252)
        v_254 = self.model_23_cv4_2_1_conv(v_253)
        v_255 = self.pnnx_unique_83(v_254)
        v_256 = self.model_23_cv4_2_2(v_255)
        v_257 = v_256.reshape(1, 32, 400)
        v_258 = torch.cat((v_245, v_251, v_257), dim=2)
        v_259 = v_208.reshape(1, 4, 16, 8400)
        v_260 = torch.transpose(v_259, dim0=2, dim1=1)
        v_261 = F.softmax(v_260, dim=1)
        v_262 = self.model_23_dfl_conv(v_261)
        v_263 = v_262.reshape(1, 4, 8400)
        v_264 = self.pnnx_fold_anchor_points_1_data
        v_265, v_266 = torch.chunk(v_263, chunks=2, dim=1)
        v_267 = (v_264 - v_265)
        v_268 = (v_264 + v_266)
        v_269 = ((v_267 + v_268) / 2)
        v_270 = (v_268 - v_267)
        v_271 = torch.cat((v_269, v_270), dim=1)
        v_272 = (v_271 * v_189)
        v_273 = F.sigmoid(v_239)
        v_274 = torch.cat((v_272, v_273), dim=1)
        v_275 = torch.cat((v_274, v_258), dim=1)
        v_276 = self.model_23_proto_cv1_conv(v_146)
        v_277 = self.pnnx_unique_84(v_276)
        v_278 = self.model_23_proto_upsample(v_277)
        v_279 = self.model_23_proto_cv2_conv(v_278)
        v_280 = self.pnnx_unique_85(v_279)
        v_281 = self.model_23_proto_cv3_conv(v_280)
        v_282 = self.pnnx_unique_86(v_281)
        v_283 = (v_275, v_282, )
        return v_283
...
def export_torchscript():
    ...
    mod.save("yolo11n_seg_pnnx.py.pt")
...
def export_onnx():
    ...
    torch.onnx.export(net, v_0, "yolo11n_seg_pnnx.py.onnx", export_params=True, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK, opset_version=13, input_names=['in0'], output_names=['out0'])
...
def export_pnnx():
    ...
    import pnnx
    pnnx.export(net, "yolo11n_seg_pnnx.py.pt", v_0)
